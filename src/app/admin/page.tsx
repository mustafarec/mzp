...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    ...
    const unsubProducts = onSnapshot(productsQuery, async (snapshot) => {
      ...
      // Ürün verilerinden kategori dağılımı hesapla
  ...
  return (
    <div className="space-y-6 bg-admin-background min-h-screen p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2 bg-admin-surface border-admin-border shadow-sm">
          <CardHeader>
